...
if __name__ == '__main__':
    ...
    while stream.has_more_samples():
        ...
        next_sample, _, is_change = stream.next_sample(batch_size=detector.omega)
        logger.track_is_change(is_change)
        logger.track_metric(detector.eta)
        detector.add_element(next_sample)
        real_changes.append(is_change)
        loss.append(detector.eta)
